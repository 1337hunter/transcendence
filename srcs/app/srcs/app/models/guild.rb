class Guild < ApplicationRecord
  ...
  has_many :war_active_started, -> { where(accepted: true, finished:false) },  class_name: "War", foreign_key: "guild1_id"
  has_many :wars_active_accepted, -> { where(accepted: true, finished:false) },  class_name: "War", foreign_key: "guild2_id"
